        ...
        >
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Link
              ...
              className="rounded-2xl surface-elevated p-4 shadow-lg hover:shadow-xl transition-all group"
            >
              <FileText className="h-6 w-6 text-secondary mb-2 group-hover:scale-110 transition-transform" />
              <h3 className="font-semibold text-primary mb-1">
                {t("student.dashboard.orders", "My Orders")}
              </h3>
              <p className="text-sm text-foreground/70">
                {t(
                  "student.dashboard.ordersDesc",
                  "Shop instruments and track your delivery or pickup orders.",
                )}
              </p>
            </Link>
          </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <a
                          ...
                          download
                          className="flex items-center gap-2 rounded-full bg-secondary/10 px-4 py-2 text-xs font-semibold text-secondary hover:bg-secondary/20 transition-colors shrink-0"
                        >
