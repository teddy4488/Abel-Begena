                ...
                {students.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    {students.map((student) => (
                      <div
                        key={student._id}
                        className="flex flex-col gap-3 rounded-xl border border-border bg-background/50 p-4 md:flex-row md:items-center md:justify-between"
                      >
                        ...
                        <div className="flex flex-col items-start gap-2 text-xs md:items-end">
                          ...
                          <select
                            ...
                            className="rounded-full border border-border bg-background/80 px-3 py-1 text-[11px] font-semibold uppercase tracking-wide outline-none transition focus:border-secondary"
                          >
